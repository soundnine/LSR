...
<link
	...
	rel="stylesheet">
<link href="/resources/css/register-free-board.css" rel="stylesheet">
</head>
<body>
	...
	<%@ include file="/WEB-INF/views/include/leftSide.jsp" %>
			...
			<div class="col-xs-12 col-sm-8">
				...
				<form action="/free/registerFreeBoard" method="post" enctype="multipart/form-data">
					<div class="title">
					...
					<div class="content">
						...
						<textarea class="form-control" cols="10" rows="20" name="content" maxlength="1300" required></textarea>
					</div>
					<div class="attach">
					<label>
	...
	$(document).ready(function(){
		...
		$('.button-wrapper button[type=submit]').on('click',function(e){
			...
			if(chk>3500){
			 ...
			 $('form[action="/free/registerFreeBoard"]').submit(); 
		});
